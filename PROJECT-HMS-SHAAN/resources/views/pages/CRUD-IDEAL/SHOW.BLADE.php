            ...
            <div class="col-md-11 col-lg-9 col-12 mt-3 mx-auto">
                <div class="card shadow-lg">
                    ...
                    <div class="card-footer text-center justify-content-between">
                        ...
                        <a href="{{ url('hospital_list/' . $data_id['id'] . '/edit') }}"
                            class="btn btn-lg btn-warning">Edit</a>
                        <form action="{{ url('hospital_list/' . $data_id['id']) }}" method="POST"
                            onsubmit="return confirm('Are you sure you want to delete this hospital?');" class="d-inline">
                            @csrf
                            @method('DELETE')
