            ...
            <div class="col-md-11 col-lg-9 col-12 mt-3 fw-bold fs-4 mx-auto"> <!-- Made width smaller -->
                <div class="card mb-4">
                    <div class="card-header">
                        <h4 class="card-title">Edit Hospital Details of <span class="text-success">{{ $hospitals->name }}</span></h4>
                        ...
                        <form action="{{ url('hospital_list/' . $hospitals->id) }}" id="hospital-form" method="post"
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control form-control-lg" id="address" name="address"
                                    placeholder="Enter Hospital Address" value="{{ old('address', $hospitals->address) }}" />
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control form-control-lg" id="website" name="website"
                                    placeholder="Enter Hospital Website URL.com" value="{{ old('website', $hospitals->website) }}" />
                                @error('website')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
