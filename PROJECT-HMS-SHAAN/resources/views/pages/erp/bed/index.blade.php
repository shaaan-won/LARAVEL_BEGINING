            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="mb-0 fw-bolder fs-2">Manage Beds</h2>
                        <a href="{{ route('beds.create') }}" class="btn btn-lg btn-primary">Add New Bed</a>
                    </div>
                    <div class="table-responsive theme-scrollbar card-body">
                        <table class="table table-striped table-responsive display dataTable no-footer" id="basic-1"
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center fw-bold text-danger fs-10">No Beds Found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
