                    ...
                    <div class="table-responsive theme-scrollbar card-body">
                        <table class="table table-striped table-responsive display dataTable no-footer" id="basic-1"
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu p-2">
                                                    <a class="dropdown-item text-success fs-6" href="{{ route('roles.show', $role->id) }}">
                                                        <i data-feather="eye" class="me-50"></i><span>View</span>
                                                    </a>
                                                    <a class="dropdown-item text-primary fs-6" href="{{ route('roles.edit', $role->id) }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="5" class="text-center fw-bold text-danger fs-10">No Roles Found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
