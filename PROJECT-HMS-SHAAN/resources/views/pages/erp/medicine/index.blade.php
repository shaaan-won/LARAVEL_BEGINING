            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h2 class="mb-0 fw-bolder fs-2">Medicine List</h2>
                        <a href="{{ route('medicines.create') }}" class="btn btn-lg btn-primary">Add Medicine</a>
                    </div>
                    <div class="table-responsive theme-scrollbar card-body">
                        <table class="table table-striped table-responsive display dataTable no-footer" id="basic-1"
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu p-2">
                                                    <a class="dropdown-item text-success fs-6" href="{{ route('medicines.show', $medicine->id) }}">
                                                        <i data-feather="eye" class="me-50"></i>
                                                        <span>Show</span>
                                                    </a>
                                                    <a class="dropdown-item text-primary fs-6" href="{{ route('medicines.edit', $medicine->id) }}">
                                                        <i data-feather="edit-2" class="me-50"></i>
                                                        <span>Edit</span>
                                                    </a>
                                                    <form action="{{ route('medicines.destroy', $medicine->id) }}" method="POST"
                                                        onsubmit="return confirm('Are you sure you want to delete this medicine?');" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="10" class="text-center fw-bold text-danger fs-10">No Medicines Found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
