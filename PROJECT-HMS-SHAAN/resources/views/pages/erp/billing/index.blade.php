                    ...
                    <div class="table-responsive theme-scrollbar card-body">
                        <table class="table table-striped table-responsive display dataTable no-footer" id="basic-1" role="grid" aria-describedby="basic-1_info">
                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu p-2">
                                                    <!-- Show Link -->
                                                    <a class="dropdown-item text-success fs-6" href="{{ route('billings.show', $billing->id) }}">
                                                        <i data-feather="eye" class="me-50"></i>
                                                        <span>Show</span>
                                                    </a>

                                                    <!-- Edit Link -->
                                                    <a class="dropdown-item text-primary fs-6" href="{{ route('billings.edit', $billing->id) }}">
                                                        <i data-feather="edit-2" class="me-50"></i>
                                                        <span>Edit</span>
                                                    </a>

                                                    <!-- Delete Link (with confirmation) -->
                                                    <form action="{{ route('billings.destroy', $billing->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this billing?');" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="13" class="text-center fw-bold text-danger fs-10">No Billings Found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
