                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('appointments.store') }}" method="POST">
						...
						<div class="mb-1">
							...
							<select name="department_id" class="form-select form-control-lg" required>
                        ...
                        <div class="mb-1">
                            ...
                            <input type="date" name="appointment_date" class="form-control form-control-lg" required value="{{ old('appointment_date') }}">
                        ...
                        <div class="mb-1">
                            ...
                            <input type="time" name="appointment_time" class="form-control form-control-lg" required value="{{ old('appointment_time') }}">
                        ...
                        <div class="mb-1">
                            ...
                            <select id="patient-type" class="form-select form-control-lg">
                                <option value="registered" {{ old('patient_type') == 'registered' ? 'selected' : '' }}>Yes</option>
                                <option value="walkin" {{ old('patient_type') == 'walkin' ? 'selected' : '' }}>No (Walk-in)</option>
                            </select>
                        </div>
                        ...
                        <div id="walkin-patient" style="display: none;">
							<div class="mb-1">
								...
								<select class="form-select form-control-lg select2" id="user_name" name="walking_user_name" >
									<option value="1">Walk-in Patient</option>
									@foreach ($users as $key => $user)
										<option value="{{ $user->id }}"
											{{ old('user_name') == $user->id ? 'selected' : '' }}>
							...
							<div class="mb-1">
								<label class="form-label fw-bold fs-5" for="name">Name</label>
								<input type="text" class="form-control form-control-lg" id="name" name="walking_name"
									placeholder="John Doe" value="{{ old('name') }}" />
								@error('name')
									<span class="text-danger">{{ $message }}</span>
								@enderror
							...
							<div class="mb-1">
								<label class="form-label fw-bold fs-5" for="email">Email</label>
								<input type="email" id="email" name="walking_email" class="form-control form-control-lg"
									placeholder="john.doe@email.com" value="{{ old('email') }}" />
								@error('email')
									<span class="text-danger">{{ $message }}</span>
								@enderror
							...
							<div class="mb-1">
								<label class="form-label fw-bold fs-5" for="blood_group">Blood Group</label>
								<select class="form-select form-control-lg" id="blood_group" name="walking_blood_group"
									value="{{ old('blood_group') }}">
									<option value="">Select Blood Group</option>
									<option value="A+">A+</option>
									<option value="A-">A-</option>
...
{{-- <div class="mb-1">
    <label class="form-label fw-bold fs-5">Department</label>
    <select name="department_id" class="form-select form-control-lg" id="departmentSelect" required>
...
<div class="mb-1">
    <label class="form-label fw-bold fs-5">Doctor</label>
    <select name="doctor_id" class="form-select form-control-lg" id="doctorSelect" required>
