            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    @if (Auth::user()->role_id == 1)
                        <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a
                                class="sidebar-link sidebar-title link-nav" href="{{ url('hospital_list') }}">
                                <svg class="stroke-icon">
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title"
                            ...
                            </svg><span>Lab Tests & Services</span></a>
                        <ul class="sidebar-submenu">
                            <li><a href="{{ url('/labtests/pending') }}">Pending Lab Tests</a></li>
                            <li><a href="{{ url('labtests') }}">Lab Tests</a></li>
                            <li><a href="{{ url('labtestcategorys') }}">Test Categories</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title"
                            href="javascript:void(0)">
...
<li class="sidebar-list"><i class="fa fa-thumb-tack"> </i><a class="sidebar-link sidebar-title link-nav "
        href="file-manager.html"> <i class="icofont icofont-doctor-alt icofont-1x"></i>
