...
use App\Models\Doctors\DoctorList;
    ...
    public function store(Request $request)
{
     ...
     */
    public function show(DoctorList $doctor)
    {
     ...
     */
    public function edit(DoctorList $doctor)
    {
     ...
     */
    public function update(Request $request, DoctorList $doctor)
    {
        // print_r($request->all());
        $request->validate([
            'user_id' => 'required',
    ...
    public function destroy(DoctorList $doctor)
    {
