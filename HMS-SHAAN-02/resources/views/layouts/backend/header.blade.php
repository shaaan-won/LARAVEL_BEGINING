<div class="header-logo-wrapper col-auto">
    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light"
                src="{{ asset('assets-mofi') }}/images/logo/logo.png" alt="" /><img class="img-fluid for-dark"
                src="{{ asset('assets-mofi') }}/images/logo/logo_light.png" alt="" /></a></div>
</div>
    ...
    <div class="row">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                        src="{{ asset('assets-mofi') }}/images/logo/logo.png" alt=""></a></div>
            ...
            <ul class="nav-menus">
                        ...
                        <ul class="notification-box">
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-primary"><img
                                        src="{{ asset('assets-mofi') }}/images/dashboard/icon/wallet.png"
                                        alt="Wallet"></div>
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-info"><img
                                        src="{{ asset('assets-mofi') }}/images/dashboard/icon/shield-dne.png"
                                        alt="Shield-dne"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-warning"><img
                                        src="{{ asset('assets-mofi') }}/images/dashboard/icon/graph.png" alt="Graph">
                                </div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex">
                                <div class="flex-shrink-0 bg-light-tertiary"><img
                                        src="{{ asset('assets-mofi') }}/images/dashboard/icon/ticket-star.png"
                                        alt="Ticket-star"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                                        <h6>Recently Paid</h6>
                                    </a>
                        ...
                        <ul class="messages">
                            <li class="d-flex b-light1-primary gap-2">
                                <div class="flex-shrink-0"><img
                                        src="{{ asset('assets-mofi') }}/images/dashboard-2/user/1.png"
                                        alt="Graph"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex b-light1-secondary gap-2">
                                <div class="flex-shrink-0"><img
                                        src="{{ asset('assets-mofi') }}/images/dashboard-2/user/2.png"
                                        alt="Graph"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                            ...
                            <li class="d-flex b-light1-success gap-2">
                                <div class="flex-shrink-0"><img
                                        src="{{ asset('assets-mofi') }}/images/dashboard-2/user/3.png"
                                        alt="Graph"></div>
                                <div class="flex-grow-1"> <a href="private-chat.html">
                        ...
                        <ul>
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                        src="{{ asset('assets-mofi') }}/images/other-images/cart-img.jpg"
                                        alt="">
                            ...
                            <li>
                                <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60"
                                        src="{{ asset('assets-mofi') }}/images/other-images/table-img.jpg"
                                        alt="">
                ...
                <li class="profile-nav onhover-dropdown px-0 py-0">
                    <div class="d-flex profile-media align-items-center"><img class="img-30"
                            src="{{ asset('assets-mofi') }}/images/dashboard/profile.png" alt="">
                        <div class="flex-grow-1"><span>{{ Auth::user()->name }}</span>
                            <p class="mb-0 font-outfit">{{ Auth::user()->email }}<i class="fa fa-angle-down"></i></p>
                        </div>
                    </div>
                    <ul class="profile-dropdown onhover-show-div"
                        style="min-width: 250px; padding: 10px; font-size: 16px;">
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <x-dropdown-link :href="route('logout')" icon="log-out"
