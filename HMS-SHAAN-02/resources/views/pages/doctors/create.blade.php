            ...
            <div class="col-md-11 col-lg-9 col-12 mt-3 fw-bold fs-4 mx-auto"> <!-- Made width smaller -->
                <div class="card mb-4">
                    <div class="card-header">
                        ...
                        <a href="{{ url('doctors') }}" class="btn btn-primary float-end">Back</a>
                    </div>
                    <div class="card-body">
                        @if (session('error'))
                        ...
                        <form action="{{ url('/doctors') }}" id="doctor-form" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="mb-1">
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control form-control-lg" id="name" name="name" placeholder="Dr. John Doe" value="{{ old('name') }}" />
                                @error('name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-1">
                                ...
                                <input type="date" class="form-control form-control-lg" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}" />
                                @error('date_of_birth')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control form-control-lg" id="specialization" name="specialization" placeholder="Cardiologist" value="{{ old('specialization') }}" />
                            ...
                            <div class="mb-1">
                                ...
                                <input type="number" class="form-control form-control-lg" id="experience" name="experience" value="{{ old('experience') }}" />
                                @error('experience')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-1">
                                ...
                                <input type="text" id="contact_number" name="contact_number" class="form-control form-control-lg" placeholder="+1234567890" value="{{ old('contact_number') }}" />
                            ...
                            <div class="mb-1">
                                ...
                                <input type="email" id="email" name="email" class="form-control form-control-lg" placeholder="doctor@email.com" value="{{ old('email') }}" />
                                @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-1">
                                ...
                                <textarea class="form-control form-control-lg" id="address" name="address" rows="3" placeholder="Clinic Address">{{ old('address') }}</textarea>
                                @error('address')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <textarea class="form-control form-control-lg" id="qualification" name="qualification" rows="3" placeholder="Medical Degrees">{{ old('qualification') }}</textarea>
                                @error('qualification')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control form-control-lg" id="registration_no" name="registration_no" placeholder="REG123456" value="{{ old('registration_no') }}" />
                            ...
                            <div class="d-flex align-items-center gap-3 mt-3">
                                ...
                                <div>
                                    <img id="photoPreview"
                                         ...
                                         style="display: {{ old('photo') ? 'block' : 'none' }}; max-width: 120px; height: auto; border: 1px solid #ccc;" />
                                </div>
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <textarea class="form-control form-control-lg" id="bio" name="bio" rows="3" placeholder="Short biography">{{ old('bio') }}</textarea>
                                @error('bio')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mb-1">
                                ...
                                <input type="text" class="form-control form-control-lg" id="available_time" name="available_time" placeholder="09:00 AM - 03:00 PM" value="{{ old('available_time') }}" />
