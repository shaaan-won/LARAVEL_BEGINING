    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-7"><img class="bg-img-cover bg-center"
                    src="{{ asset('assets-mofi') }}/images/login/2.jpg" alt="looginpage"></div>
            <div class="col-xl-5 p-0">
                <div class="login-card login-dark">
                    <div>
                        <div><a class="logo text-start" href="index.html"><img class="img-fluid for-light"
                                    src="{{ asset('assets-mofi') }}/images/logo/logo.png" alt="looginpage"><img
                                    class="img-fluid for-dark"
                                    src="{{ asset('assets-mofi') }}/images/logo/logo_dark.png" alt="looginpage"></a>
                        </div>
