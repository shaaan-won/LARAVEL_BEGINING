<div class="header-logo-wrapper col-auto">
    <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="{{ asset('assets-mofi')}}/images/logo/logo.png" alt=""/><img class="img-fluid for-dark" src="{{ asset('assets-mofi')}}/images/logo/logo_light.png" alt=""/></a></div>
  </div>
  <div class="col-4 col-xl-4 page-title">
    <h4 class="f-w-700"> Education Dashboard</h4>
    <nav>
...
<div class="header-wrapper col m-0">
    <div class="row">
      ...
      <div class="header-logo-wrapper col-auto p-0">
        <div class="logo-wrapper"><a href="index.html"><img class="img-fluid" src="{{ asset('assets-mofi')}}/images/logo/logo.png" alt=""></a></div>
      ...
      <div class="nav-right col-xxl-8 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
        <ul class="nav-menus">
          <li>                         <span class="header-search">
              <svg>
                <use href="{{ asset('assets-mofi')}}/svg/icon-sprite.svg#search"></use>
              </svg></span></li>
          <li>
            <div class="form-group w-100">
              <div class="Typeahead Typeahead--twitterUsers">
          ...
          <li class="onhover-dropdown">
            <div class="notification-box">
              <svg>
                <use href="{{ asset('assets-mofi')}}/svg/icon-sprite.svg#notification"></use>
            ...
            <div class="onhover-show-div notification-dropdown">
              ...
              <ul class="notification-box">
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-primary"><img src="{{ asset('assets-mofi')}}/images/dashboard/icon/wallet.png" alt="Wallet"></div>
                ...
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-info"><img src="{{ asset('assets-mofi')}}/images/dashboard/icon/shield-dne.png" alt="Shield-dne"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-warning"><img src="{{ asset('assets-mofi')}}/images/dashboard/icon/graph.png" alt="Graph"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="d-flex"> 
                  <div class="flex-shrink-0 bg-light-tertiary"><img src="{{ asset('assets-mofi')}}/images/dashboard/icon/ticket-star.png" alt="Ticket-star"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
          ...
          <li class="onhover-dropdown">
            <svg>
              <use href="{{ asset('assets-mofi')}}/svg/icon-sprite.svg#header-bookmark"></use>
            </svg>
          ...
          <li>
            <div class="mode">
              <svg>
                <use href="{{ asset('assets-mofi')}}/svg/icon-sprite.svg#moon"></use>
              </svg>
            </div>
          </li>
          <li class="onhover-dropdown">
            <div class="notification-box">
              <svg>
                <use href="{{ asset('assets-mofi')}}/svg/icon-sprite.svg#header-message"></use>
            ...
            <div class="onhover-show-div notification-dropdown">
              ...
              <ul class="messages">
                <li class="d-flex b-light1-primary gap-2"> 
                  <div class="flex-shrink-0"><img src="{{ asset('assets-mofi')}}/images/dashboard-2/user/1.png" alt="Graph"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="d-flex b-light1-secondary gap-2"> 
                  <div class="flex-shrink-0"><img src="{{ asset('assets-mofi')}}/images/dashboard-2/user/2.png" alt="Graph"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
                ...
                <li class="d-flex b-light1-success gap-2"> 
                  <div class="flex-shrink-0"><img src="{{ asset('assets-mofi')}}/images/dashboard-2/user/3.png" alt="Graph"></div>
                  <div class="flex-grow-1"> <a href="private-chat.html">
          ...
          <li class="cart-nav onhover-dropdown">
            ...
            <div class="cart-dropdown onhover-show-div">
              ...
              <ul>
                <li>
                  <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('assets-mofi')}}/images/other-images/cart-img.jpg" alt="">
                ...
                <li>
                  <div class="d-flex"><img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('assets-mofi')}}/images/other-images/table-img.jpg" alt="">
          ...
          <li class="profile-nav onhover-dropdown px-0 py-0">
            <div class="d-flex profile-media align-items-center"><img class="img-30" src="{{ asset('assets-mofi')}}/images/dashboard/profile.png" alt="">
      ...
      <script class="result-template" type="text/x-handlebars-template">
        ...
        <div class="ProfileCard-realName">SHAWON</div>
        </div>
        </div>
      </script>
