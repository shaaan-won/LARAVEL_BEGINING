...
--corrected table structure for `hms_doctors` 
...
CREATE table hms_medicine_categories(
...
CREATE table hms_medicine_sub_categories(
id int(11) primary key NOT NULL,
name varchar(255) NOT NULL,
description text DEFAULT NULL,
created_at datetime DEFAULT current_timestamp(),  
...
CREATE table hms_medicine_suppliers(
id int(11) primary key NOT NULL,
name varchar(255) NOT NULL,
address text DEFAULT NULL,
...
CREATE table hms_medicine_stock(
id int(11) primary key NOT NULL,
...
CREATE table hms_medicine_purchases(
id int(11) primary key NOT NULL,
medicine_id int(11) NOT NULL,
supplier_id int(11) NOT NULL,
quantity int(11) NOT NULL,
...
CREATE table hms_appointments_details(
id int(11) primary key NOT NULL,
...
CREATE TABLE if not exists `hms_doctors` (
  ...
  `bio` text DEFAULT NULL,
  `consultation_fee` decimal(10,2) DEFAULT NULL,
  `status_id` enum('Active','Inactive') DEFAULT 'Active',
  `created_at` datetime DEFAULT current_timestamp(),
  `updated_at` datetime DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
