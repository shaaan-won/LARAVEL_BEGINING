(function ($) {
  ...
  // $(document).ready(function () {
  //   let contentWrapper = $(".simplebar-wrapper .simplebar-content-wrapper");
  //   let activeLink = contentWrapper.find("a.active");
...
//     if (
//       contentWrapper.length &&
//       activeLink.length && // Ensure activeLink exists before using .offset()
//       $("#pageWrapper").hasClass("compact-wrapper")
//     ) {
//       let activeOffset = activeLink.offset(); // Get offset safely
  
//       if (activeOffset) {
//         contentWrapper.animate(
//           {
//             scrollTop: activeOffset.top - 400,
//           },
//           1000
//         );
//       }
...
//   console.log("Active Link Exists? ", activeLink.length > 0);
